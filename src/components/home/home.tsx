  ...
  return (
    <main className="flex justify-center items-center h-screen w-full">
      <div className="flex flex-col items-center text-center max-w-full">
        ...
        <h1 className="text-4xl/12 font-extrabold md:text-[6.75rem]/[6.75rem]">Desenvolvedor<br />Full Stack</h1>
        <p className="text-sm md:text-base text-foreground/60 px-2 md:px-0">
          Sou desenvolvedor Full Stack, apaixonado por tecnologia e por construir aplicações funcionais. <br />Este site reúne alguns dos meus principais projetos e experiências.
        </p>
      </div>
    </main>
  )
